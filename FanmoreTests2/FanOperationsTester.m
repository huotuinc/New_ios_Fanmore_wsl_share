...
void mymethodimp4(FanOperationsTester* self,SEL _cmd,id delegate,void (^block)(id,NSError*),id v1,id v2,id v3,id v4){
    objc_msgSend(self.imps,_cmd,delegate,getblock(self, _cmd, block),v1,v2,v3,v4);
    checkfinish(self);
}
        ...
        if (md.name!=NULL && md.types!=NULL) {
            ...
            switch (hits) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    class_addMethod(self, mname, (IMP)mymethodimp4,types);
                    break;
                default:
                    LOG(@"还无法支持太多参数的接口");
            }
